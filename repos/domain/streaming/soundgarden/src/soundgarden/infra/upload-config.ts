import { optionalNumberEnvCompute, optionalStringEnvCompute } from '@repo/environment'
...
export function getUploadMaxSizeBytes(): number {
  return optionalNumberEnvCompute(
...
export function getUploadStoragePath(): string {
  return optionalStringEnvCompute('UPLOAD_STORAGE_PATH', UPLOAD_STORAGE_PATH_DEFAULT)
}

export function getUploadStorageBucket(): string {
  return optionalStringEnvCompute(
